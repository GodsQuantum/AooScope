...
fn media_layers() -> Vec<Layer> {
    layers(vec![
        ...
        json!({"id":"media-headline","type":"text","binding":"aooscope_media_display_headline","x":330,"y":62,"width":568,"height":54,"z":6,"color":"#62e3a3","scale":6}),
        json!({"id":"media-title","type":"text","binding":"aooscope_media_display_title_short","x":330,"y":128,"width":568,"height":58,"z":6,"color":"#f4fbff","scale":4}),
